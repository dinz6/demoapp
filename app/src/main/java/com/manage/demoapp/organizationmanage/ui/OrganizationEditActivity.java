...
public class OrganizationEditActivity extends AppCompatActivity implements PictureAdapter.onAddPicClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        org = getIntent().getParcelableExtra(OrganizationActivity.ORG);
        ...
        org_stars.setOnRatingBarChangeListener((ratingBar, rating, fromUser) -> {
            stars = (int) rating;
        });
